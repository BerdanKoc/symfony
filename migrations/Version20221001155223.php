 ...
 */
final class Version20221001155223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE films (id INT AUTO_INCREMENT NOT NULL, genre_id INT NOT NULL, titre VARCHAR(255) NOT NULL, resume LONGTEXT NOT NULL, annee_de_sortie INT NOT NULL, affiche LONGBLOB NOT NULL, INDEX IDX_CEECCA514296D31F (genre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
